...
// Handle form submission (optional if you're also adding from this page)
                            ...
                            while ($row = $employers->fetch_assoc()) {
                                echo "<tr>
                                    ...
                                    <td class='action-buttons'>
                                        <a href='view_employer.php?id={$row['id']}' class='btn btn-info btn-sm'>View</a>
                                        <a href='edit_employer.php?id={$row['id']}' class='btn btn-warning btn-sm'>Edit</a>
                                        <a href='delete_employer.php?id={$row['id']}' class='btn btn-danger btn-sm' onclick='return confirm(\"Are you sure you want to delete this employer?\");'>Delete</a>
                                    </td>
                                </tr>";
                                $i++;
                            }
